...
MySQLModel.methods = ["find", "save", "delete","remove", "safeDelete"];
...
MySQLModel.prototype.create = MySQLModel.prototype.reUse = function (newJsObject) {
    this.jsObject = newJsObject;
...
MySQLModel.prototype.getRawObject = function () {
...
MySQLModel.prototype.delete = MySQLModel.prototype.remove = function () {
    var def = Promise.defer();
    var primaryKeyValue = this[this.table.primaryKey];
