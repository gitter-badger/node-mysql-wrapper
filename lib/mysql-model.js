...
MySQLModel.prototype.parseTable = function (mysqlTableToSearch, parentObject) {
    ...
    for (var key in tableObj) {
        ...
        //   if (typeof _val === 'string' || _val instanceof String || isNumber(_val)) {
        //[Greek- for me] edw elenxw an einai string to value i enas ari9mos, ena id px, aliws einai object pou mesa tou periexei kiallo table.
...
MySQLModel.prototype.save = function () {
    ...
    if (primaryKeyValue > 0) {
        ...
        this.table.connection.query(_query, function (err, result) {
            ...
            self.connection.notice(self.table.name, _query, self.jsObject);
